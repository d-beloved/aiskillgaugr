    ...
    <div className="flex justify-center items-center min-h-[80vh] animate-fade-in">
      <div className="max-w-4xl w-full px-4">
        ...
        <div className="text-center space-y-8">
          <h1 className="text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary animate-slide-up">
          ...
          <p className="text-xl text-slate-400 animate-slide-up">Select a language and level to start the quiz</p>
          {renderButton()}
        </div>
      </div>
