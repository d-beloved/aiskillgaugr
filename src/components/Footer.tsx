import { handleVisitRepository } from "@/layouts/LayoutDefault";
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="link link-hover flex items-center gap-2 opacity-75 hover:opacity-100 
          ...
          >
            ...
            <span className="hover:text-primary transition-colors">Star on GitHub</span>
          </a>
        </div>
      </div>
    </footer>
